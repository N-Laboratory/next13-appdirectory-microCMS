        ...
        <div className="flex flex-col items-center rounded-lg bg-gray-100 p-4 sm:p-8">
          ...
          <div className="flex flex-col items-center w-full">
            <form className="mb-3 flex w-full max-w-md gap-2" onSubmit={handleSubmit}>
              <input name="serachWord" value={keyword} onChange={handleChange} required placeholder="search word" className="border-black w-full flex-1 rounded border bg-gray-50 px-3 py-2 text-gray-800 placeholder-gray-500 outline-none ring-indigo-300 transition duration-100 focus:ring" />
