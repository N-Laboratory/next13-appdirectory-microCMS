    ...
    <div className="bg-white pb-12 flex-grow">
      <div className="mx-auto max-w-screen-2xl px-4 md:px-8">
        <div className="flex flex-col items-center gap-4 md:gap-6">
          ...
          <div className="max-w-md text-gray-600 lg:text-lg">5年目を迎えるWebエンジニア。Javaを利用したSpring Bootでの開発経験を経て、現在はTypescript/Vue/Nuxt関連のスキルを磨いています。</div>
          <div className="max-w-md text-gray-600 lg:text-lg">今までずっとサーバーサイド寄りな開発経験しかなかったのでフロントエンドの技術の進歩と奥の深さに驚く日々を過ごしています。</div>
          ...
          <div className="flex items-center gap-2 flex-row md:gap-3">
            ...
            <div>
              <div className="text-center text-sm font-bold text-indigo-500 sm:text-left md:text-base">Naoki Nakanishi</div>
